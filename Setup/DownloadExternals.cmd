...
IF NOT EXIST "%~p0\..\bin\Git-2.6.3-64-bit.exe" (
    "%~p0\tools\curl.exe" -L -k -o ..\bin\Git-2.6.3-64-bit.exe https://github.com/git-for-windows/git/releases/download/v2.6.3.windows.1/Git-2.6.3-64-bit.exe
